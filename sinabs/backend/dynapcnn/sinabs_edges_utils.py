...
VALID_SINABS_EDGES = {
    0: (nn.Conv2d, sl.iaf.IAFSqueeze),           # convoluion is always followed by a neuron layer.
    ...
    7: (sl.iaf.IAFSqueeze, sl.SumPool2d),        # same as key `1` but with `sl.SumPool2d` instead.
