...
def test_deepcopy_expleak():
    ...
    layer = ExpLeak(tau_leak=10.0)
    layer_squeeze_nts = ExpLeakSqueeze(tau_leak=10.0, num_timesteps=10)
    layer_squeeze_batch = ExpLeakSqueeze(tau_leak=10.0, batch_size=10)
