...
expected_output = {
    ...
    "nodes_io_shapes": {
        ...
        6: {"input": torch.Size([4, 16, 16]), "output": torch.Size([4, 15, 15])},
        7: {"input": torch.Size([4, 15, 15]), "output": torch.Size([4, 15, 15])},
        12: {"input": torch.Size([4, 15, 15]), "output": torch.Size([4, 15, 15])},
        8: {"input": torch.Size([4, 15, 15]), "output": torch.Size([4, 7, 7])},
        13: {"input": torch.Size([4, 15, 15]), "output": torch.Size([4, 7, 7])},
        9: {"input": torch.Size([4, 7, 7]), "output": torch.Size([4, 6, 6])},
        14: {"input": torch.Size([4, 7, 7]), "output": torch.Size([4, 6, 6])},
        10: {"input": torch.Size([4, 6, 6]), "output": torch.Size([4, 6, 6])},
        15: {"input": torch.Size([4, 6, 6]), "output": torch.Size([4, 6, 6])},
        11: {"input": torch.Size([4, 6, 6]), "output": torch.Size([144, 1, 1])},
        16: {"input": torch.Size([4, 6, 6]), "output": torch.Size([144, 1, 1])},
        19: {"input": torch.Size([144, 1, 1]), "output": torch.Size([144, 1, 1])},
        17: {"input": torch.Size([144, 1, 1]), "output": torch.Size([10, 1, 1])},
        18: {"input": torch.Size([10, 1, 1]), "output": torch.Size([10, 1, 1])},
    },
}
