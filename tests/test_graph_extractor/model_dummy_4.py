...
expected_output = {
    ...
    "entry_nodes": {0},
    "nodes_io_shapes": {
        0: {"input": torch.Size([2, 2, 34, 34]), "output": torch.Size([2, 1, 33, 33])},
        1: {"input": torch.Size([2, 1, 33, 33]), "output": torch.Size([2, 1, 33, 33])},
        2: {"input": torch.Size([2, 1, 33, 33]), "output": torch.Size([2, 1, 32, 32])},
        3: {"input": torch.Size([2, 1, 33, 33]), "output": torch.Size([2, 1, 32, 32])},
        4: {"input": torch.Size([2, 1, 32, 32]), "output": torch.Size([2, 1, 32, 32])},
        7: {"input": torch.Size([2, 1, 32, 32]), "output": torch.Size([2, 1, 32, 32])},
        5: {"input": torch.Size([2, 1, 32, 32]), "output": torch.Size([2, 1, 16, 16])},
        8: {"input": torch.Size([2, 1, 32, 32]), "output": torch.Size([2, 1, 16, 16])},
        9: {"input": torch.Size([2, 1, 32, 32]), "output": torch.Size([2, 1, 6, 6])},
        6: {"input": torch.Size([2, 1, 16, 16]), "output": torch.Size([2, 1, 16, 16])},
        10: {"input": torch.Size([2, 1, 6, 6]), "output": torch.Size([2, 1, 5, 5])},
        11: {"input": torch.Size([2, 1, 16, 16]), "output": torch.Size([2, 1, 15, 15])},
        17: {"input": torch.Size([2, 1, 5, 5]), "output": torch.Size([2, 1, 5, 5])},
        12: {"input": torch.Size([2, 1, 15, 15]), "output": torch.Size([2, 1, 15, 15])},
        16: {"input": torch.Size([2, 1, 5, 5]), "output": torch.Size([2, 25])},
        13: {"input": torch.Size([2, 1, 15, 15]), "output": torch.Size([2, 1, 5, 5])},
        14: {"input": torch.Size([2, 1, 5, 5]), "output": torch.Size([2, 25])},
        15: {"input": torch.Size([2, 25]), "output": torch.Size([2, 25])},
        18: {"input": torch.Size([2, 25]), "output": torch.Size([2, 10])},
        19: {"input": torch.Size([2, 10]), "output": torch.Size([2, 10])},
    },
}
