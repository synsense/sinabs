...
expected_output = {
    ...
    "entry_nodes": {0},
    "nodes_io_shapes": {
        0: {"input": torch.Size([2, 34, 34]), "output": torch.Size([10, 33, 33])},
        1: {
            "input": torch.Size([10, 33, 33]),
            "output": torch.Size([10, 33, 33]),
        },
        2: {
            "input": torch.Size([10, 33, 33]),
            "output": torch.Size([10, 11, 11]),
        },
        3: {"input": torch.Size([10, 33, 33]), "output": torch.Size([10, 8, 8])},
        4: {"input": torch.Size([10, 11, 11]), "output": torch.Size([10, 8, 8])},
        6: {"input": torch.Size([10, 8, 8]), "output": torch.Size([10, 8, 8])},
        5: {"input": torch.Size([10, 8, 8]), "output": torch.Size([10, 8, 8])},
        7: {"input": torch.Size([10, 8, 8]), "output": torch.Size([1, 7, 7])},
        8: {"input": torch.Size([1, 7, 7]), "output": torch.Size([1, 7, 7])},
        9: {"input": torch.Size([1, 7, 7]), "output": torch.Size([49, 1, 1])},
        10: {"input": torch.Size([49, 1, 1]), "output": torch.Size([500, 1, 1])},
        11: {"input": torch.Size([500, 1, 1]), "output": torch.Size([500, 1, 1])},
        12: {"input": torch.Size([500, 1, 1]), "output": torch.Size([10, 1, 1])},
        13: {"input": torch.Size([10, 1, 1]), "output": torch.Size([10, 1, 1])},
    },
}
