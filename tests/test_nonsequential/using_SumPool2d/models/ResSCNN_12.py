...
class SCNN(nn.Module):
    def __init__(self, input_size, nb_classes, batch_size, surrogate_fn, min_v_mem=-0.313, spk_thr=2.0) -> None:
        ...
        self.conv1 = nn.Conv2d(2, 1, 3, 1, bias=False)
        ...
        self.conv2 = nn.Conv2d(1, 8, 3, 1, bias=False)
        ...
        self.fc1 = nn.Linear(32, 1024, bias=False)
    ...
    def rescale_conv_weights(self, rescale_fn, lambda_):
        rescale_fn(self.conv2, [(3, 3)], lambda_)
        rescale_fn(self.conv3, [(3, 3)], lambda_)
        rescale_fn(self.conv4, [(3, 3)], lambda_)
