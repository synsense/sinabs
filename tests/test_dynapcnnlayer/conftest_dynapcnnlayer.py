...
args_DynapcnnLayer = [
    (nodes_to_dcnnl_map, 0, sinabs_edges, expected_output), 
    (nodes_to_dcnnl_map, 1, sinabs_edges, expected_output), 
    (nodes_to_dcnnl_map, 2, sinabs_edges, expected_output), 
    (nodes_to_dcnnl_map, 3, sinabs_edges, expected_output), 
    (nodes_to_dcnnl_map, 4, sinabs_edges, expected_output), 
]